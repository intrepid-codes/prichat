...
<head>
    ...
    <title>
        Login | Coolest Chatting Platform In India
    </title>
    ...
    <div id="cursor"></div>
            ...
            <div id="brand">
                ...
                <div id="menu-opener">
                    <div id="menuBox">
                        <h4>Menu</h4>
                        <div id="linkBox">
                            <a href="index.php"><span>Home</span><span>Home</span></a>
                            <a href="login.php"><span>Login</span><span>Login</span></a>
        ...
        <div id="login-container">
            ...
            <form>
                ...
                <h4 id="register-btn">Don't have an account? <a href="signup.php">Register now</a></h4>
            </form>
        </div>
    </div>
</div>
...
<script>
    ...
    var needBlur = document.querySelector('#login-container')
